...
Func _Localization_Menus()
	...
	$g_aLangMenus[17] = _Localization_Load("Menus", "Help_Contact", "&Contact %{Company.Name}")
...
Func _Localization_Preferences()
	...
	$g_aLangPreferences[4]  = _Localization_Load("Preferences", "Group_Cache", "Cache")
	...
	$g_aLangPreferences[7]  = _Localization_Load("Preferences", "Checkbox_Cache_Exit", " Clear cache on exit")
	$g_aLangPreferences[8]  = _Localization_Load("Preferences", "Label_Cache_Size", "Cache Size: %s KB")
	$g_aLangPreferences[9]  = _Localization_Load("Preferences", "Button_Cache_Clear", "Clear Cache")
